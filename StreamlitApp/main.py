...
def load_data(PRODUCT_ID, STORE_ID):
    data_init = pd.read_csv(f'https://github.com/NathanSglr/test/blob/df21db6ad4ffa4666857af0b55dc901575f8cd72/StreamlitApp/DataCSV/{PRODUCT_ID}_{STORE_ID}.csv?raw=true')
