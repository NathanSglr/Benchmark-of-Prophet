...
def load_data(PRODUCT_ID, STORE_ID):
    data_init = pd.read_csv(f'https://github.com/NathanSglr/test/blob/0d6f95175229d64614809af0f9db61e0a91d1527/StreamlitApp/{PRODUCT_ID}_{STORE_ID}.csv?raw=true')
