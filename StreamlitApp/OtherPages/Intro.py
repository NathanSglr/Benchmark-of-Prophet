...
def app():
    ...
    st.write('------------------------------------------------------------------------------------------------------------------------')
    c1, c2 = st.columns(2)
    c1.image('https://github.com/NathanSglr/test/blob/main/StreamlitApp/Pictures/Equancy_logo.png?raw=true')

    c2.image('https://github.com/NathanSglr/test/blob/main/StreamlitApp/Pictures/IMTA_logo.png?raw=true')
    st.write('------------------------------------------------------------------------------------------------------------------------')
    ...
    c4.image('https://github.com/NathanSglr/test/blob/main/StreamlitApp/Pictures/logos_all.png?raw=true')
    st.write('------------------------------------------------------------------------------------------------------------------------')
